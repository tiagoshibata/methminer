...
static void headers(vector<string>& h, bool color) {
    ...
    ss.str("");
    ss << white << "https://github.com/tiagoshibata/methminer";
    h.push_back(ss.str());
        ...
        if (vm.count("help-module")) {
            ...
            if (s == "con")
                cout << "\n\nConnections specifications :\n\n"
                     ...
                     << "    command line argument. See 'methminer -H misc' for details.\n\n"
...
int main(int argc, char** argv) {
    ...
    if (argc < 2) {
        ...
        cout << "Try 'methminer --help' to get a list of arguments.";
        return 1;
    }
